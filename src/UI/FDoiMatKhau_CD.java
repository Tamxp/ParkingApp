 ...
 * @author Admin
 */
public class FDoiMatKhau_CD extends javax.swing.JFrame {

    /**
     * Creates new form FDoiMatKhau
     */
    public FDoiMatKhau_CD() {
        initComponents();
        setSize(1100, 666);
            ...
            if (txtTaikhoan.getText().equals("")) {
                ...
                if (pw.equals(cpw)) {
                    if (txtTaikhoan.getText().equals("admin")) {
                        ...
                        int doimaykhau = dn.DoiMK_CD(taikhoan, pw, mkold);
                        if (doimaykhau > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FDoiMatKhau_CD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
